...
\node[draw, rounded corners=3pt, fill=red!50] at (1,0.8) {High Complexity};
\node[draw, rounded corners=3pt, fill=yellow!50] at (8,0.8) {Medium};
\node[draw, rounded corners=3pt, fill=green!50] at (16,0.8) {Low Complexity};
