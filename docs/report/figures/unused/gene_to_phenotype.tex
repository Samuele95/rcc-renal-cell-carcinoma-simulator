...
\node[below] at (1,5.5) {\footnotesize VHL=1, CD274=2};
\node[below] at (1,5.2) {\footnotesize Fast growth};
\node[below] at (1,4.9) {\footnotesize High PD-L1};

\node[draw, rounded corners=3pt, fill=yellow!70] at (17,6) {Example 2};
\node[below] at (17,5.5) {\footnotesize TP53=1, B2M=1};
\node[below] at (17,5.2) {\footnotesize Apoptosis resist};
\node[below] at (17,4.9) {\footnotesize Immune invisible};
