...
\epigraph{With four parameters I can fit an elephant.}{--- John von Neumann}

A computational model is only as good as its parameters. This chapter reveals how 92 precisely tuned parameters --- optimized by Bayesian machine learning against real clinical trial data --- transform an abstract biological theory into a predictive medical tool.
...
Ninety-two parameters are tuned by Bayesian optimization (Optuna) against real ARON-1 clinical trial data. This isn't just model fitting --- it's teaching the virtual tumor to behave like real patient tumors, creating a bridge between computational biology and clinical medicine.
\end{tcolorbox}
