...
\begin{figure}[htbp]
\centering
\resizebox{0.85\textwidth}{!}{\input{figures/architecture_overview.tex}}
...
\begin{figure}[htbp]
\centering
\resizebox{0.85\textwidth}{!}{\input{figures/simulation_pipeline.tex}}
...
\begin{figure}[htbp]
\centering
\resizebox{0.85\textwidth}{!}{\input{figures/model_architecture.tex}}
